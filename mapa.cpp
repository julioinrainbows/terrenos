...
/**      
         * Primeiro importamos a paleta e atribuimos valores aleatorios para os cantos do mapa de altitudes.
         ...
         * Ao finalizar a etapa diamond, ou seja, o(s) valor(es) central entre os extremos está definido, iniciamos a etapa square, a qual serve para definir novos valores ao redor do centro do ponto.
...
/**
 * O metodo para pegar as altitudes consiste em retornar o valor do ponto a partir de suas cordenadas.
 */
 ...
 * Semelhante ao processo de leitura da paleta utilizamos uma string que armazenara o conteudo lido do arquivo e depois o aloca a um vetor, além disso após cada leitura de linha uma variavel é incrementada em 1 unidade, ela representa as dimensões do mapa de altitudes(matriz quadrada).
